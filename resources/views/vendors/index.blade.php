                            ...
                            <div class="modal-body">
                                <form action="{{ route('companies.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                                                <label for="vendor_slug" class="mb-2 black bold">المعرف
                                                    (Slug)</label>
                                                <input type="text" class="theme-input-style mb-2" name="slug"
                                                    id="vendor_slug" placeholder="اكتب المعرف هنا">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-4">
                        ...
                        <tbody>
                            @foreach($data as $one)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $one->name ?? '' }}</td>
                                    <td style="display:none;">{{ $one->slug ?? '' }}</td>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('companies.update', $one->id ?? 0) }}" method="POST"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group mb-4">
                                                                <label for="vendor_slug" class="mb-2 black bold">المعرف</label>
                                                                <input type="text" class="theme-input-style" id="vendor_slug" name="slug"
                                                                    value="{{ $one->slug ?? '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
