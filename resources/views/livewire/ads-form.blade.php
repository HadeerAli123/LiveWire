<div>
    <form wire:submit.prevent="save">
        ...
        <div class="contact-account-setting media-body d-flex justify-content-between align-items-center"
             style="background:#e3e4e6;border-radius:12px;padding:20px 15px;margin-bottom:24px;box-shadow:0 2px 8px rgba(0,0,0,.04);">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="form-group mb-4">
                    ...
                    <input type="file" wire:model="image" class="theme-input-style"
